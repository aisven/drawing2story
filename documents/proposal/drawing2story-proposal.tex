...
\usepackage{./hbrs-inf}
% graphicx to include images or figures
\usepackage{graphicx}
\graphicspath{ {./images/} }
...
\input{./section/subsection/contributions}
...
\input{./section/subsection/emotional_design}
\input{./section/subsection/media_design}
